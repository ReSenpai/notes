...
Последня тема, великая и ужасная - бесконечная петля. Циклы - это отличные инструменты, когда вам нужно, что бы ваша программа запускала блок кода определенное количество раз или до тех пор, пока не будет выполнено условие. Но им нужно терминальное условие, которое завершит цикл.

Бесконечные циклы скорее всего заморозят или сломают браузер и вызовут общий сбой выполнения программы, который никому не нужен.

Как пример такого цикла:
...
Задача программиста состоит в том, чтобы гарантировать, что конечное условие, которое говорит программе когда нужно вырваться из цикла кода, в конечном итоге будет достигнуто.

Одна ошибка заключается в увеличении или уменьшении переменной счетчика в неправильном направлении от терминального условия.

Другая заключается в случайном сбросе счетчика или индексной переменной в коде цикла, а не в ее увеличении или уменьшении.
